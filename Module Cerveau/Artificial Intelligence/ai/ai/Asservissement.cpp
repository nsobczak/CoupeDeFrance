...
void Asservissement::botGoForward(double speed)
{
        ...
        double decpart = speed - intpart;
        i2csend3bytes(_ASSERVISSMENT_BOTGOFORWARD_, intpart, decpart, _ASSERVISSMENT_SENDADRESS_);
}
...
void Asservissement::botGoBackward(double speed)
{
        ...
        int intpart = (int)speed;
        double decpart = speed - intpart;
        i2csend3bytes(_ASSERVISSMENT_BOTGOBACKWARD_, intpart, decpart, _ASSERVISSMENT_SENDADRESS_);
}
...
void Asservissement::botTurnAroundRight(double speed)
{
        ...
        int intpart = (int)speed;
        double decpart = speed - intpart;
        i2csend3bytes(_ASSERVISSMENT_BOTTURNRIGHT_, intpart, decpart, _ASSERVISSMENT_SENDADRESS_);
}
...
void Asservissement::botTurnAroundLeft(double speed)
{
        ...
        int intpart = (int)speed;
        double decpart = speed - intpart;
        i2csend3bytes(_ASSERVISSMENT_BOTTURNLEFT_, intpart, decpart, _ASSERVISSMENT_SENDADRESS_);
}
